const News = require("../models/lainnyaModel");
...
exports.deleteNews = async (req, res) => {
  try {
    const { id } = req.params;
    console.log("Deleting news with ID:", id); // Log ID yang diterima
    ...
    console.log("Attempting to delete image at:", imagePath); // Log path gambar
    ...
    console.error("Error in deleteNews:", error); // Tambahkan log error
